...
set-option -g status-style fg=$base02,bg=$base01,default

set-window-option -g window-status-style fg=$base03,bg=$base07
...
tm_host="#[fg=$base0E,bg=$base01] #h "
set -g status-right "Test $tm_date $tm_host"
